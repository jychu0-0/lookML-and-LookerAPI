    ...
    sql:
      ...
      SELECT
          ...
          , CASE
              ...
              WHEN if.customer_id IN (598202,8211998) THEN 'Costco'
      ...
      SELECT
          ...
          , CASE
              WHEN end_customer_id IN (129881,5486306) THEN 'Best Buy'
              WHEN end_customer_id IN (4560,135103,8038322,7225817) THEN 'Amazon'
              WHEN end_customer_id IN (598202,8211998) THEN 'Costco'
      ...
      FROM redacted r
      LEFT JOIN netsuite.customers c ON c.customer_id = r.customer_id
      LEFT JOIN netsuite.customers ec ON ec.customer_id = end_customer_id;;
